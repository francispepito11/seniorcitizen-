...
$id=intval($_GET['id']);
$sql=mysqli_query($con,"update tblseniorcitizen set Name='$namesc',DateofBirth='$dob', ContactNumber='$contnum',CommunicationAddress='$commadd',EmergencyAddress='$emeradd',EmergencyContactnumber='$emercontnum',Gender='$gender' where ID='$id'" );
...
<head>
  ...
  <title>Senior Citizen Updates and Information System  || Update Services</title>
  <!-- base:css -->
...
?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input id="Gender" name="Gender" type="text" class="form-control" required="true" value="<?php echo htmlentities($row['Gender']);?>">
                    </div>
     <div class="form-group">
