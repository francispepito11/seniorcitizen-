...
echo "<script>window.location.href='manage-scdetails.php'</script>";
          ...
          if ($_GET['archive']) {
            $scid = $_GET['id'];
            mysqli_query($con, "UPDATE tblseniorcitizen SET isArchived = 1 WHERE ID ='$scid'");
            echo "<script>alert('Data Archived');</script>";
            echo "<script>window.location.href='manage-scdetails.php'</script>";
        }
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <a href="manage-scdetails.php?id=<?php echo $row['ID']; ?>&archive=1" onClick="return confirm('Are you sure you want to archive this record?')" class="btn btn-warning btn-sm btn-icon-text">Archive <i class="typcn typcn-folder btn-icon-append"></i></a>
                          </div>
                        </td>
                      </tr><?php $cnt=$cnt+1; } ?>
